...
export const BentoGridItem = ({
	...
	return (
		<div
			className={cn(
				"group/bento shadow-input row-span-1 flex flex-col justify-between space-y-4 relative overflow-hidden rounded-3xl transition duration-200 hover:shadow-xl dark:shadow-none border border-white/10",
				className,
			)}
			style={{
				...
				>
					...
					{id === 3 && (
						<div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
							...
							<div className="flex flex-col gap-3 lg:gap-8">
								<span className="py-4 px-3 rounded-lg text-center bg-[#10132E]"></span>
								{["Tailwind CSS", "Angular", "NestJS"].map((item) => (
									<span
										key={item}
										className="py-2 lg:py-4 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]"
									>
